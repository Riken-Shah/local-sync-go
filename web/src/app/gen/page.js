...
import TextHelper from "./components/TextHelpers"
import {getAllOrgUsers, getCurrentTasks, getOrgUser, getRoles, getStyles} from "../../../utils/helpers";
    ...
    useEffect(() => {
        onAuthStateChanged(auth, (user) => {
            if (user) {
                ...
                // getStyles().then((styles) => console.log("getting styles"))
                // getOrgUser().then((orgUser) => setOrgUser(orgUser)
